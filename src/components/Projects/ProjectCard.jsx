...
export const ProjectCard = ({ project: {title, imagePath, description, github} }) => {
  return (
    <div className="max-w-sm mx-auto my-6 rounded overflow-hidden shadow-lg bg-white border-4 border-white transition duration-500 hover:-translate-y-1 hover:scale-105">
        ...
        <div className="px-6 pt-4 pb-2">
            <a href={github} className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Github</a>
        </div>
    </div>
  )
}
