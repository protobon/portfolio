...
export const Navbar = () => {
  ...
  <nav className='flex justify-between items-center text-white h-24 mx-auto px-4'>
    <a href="/" className='text-2xl'><h1>Portfolio</h1></a>
    ...
    <div className={`md:hidden font-semibold ${navMenu ? 'fixed right-0 top-24 w-[35%] max-w-[200px] bg-black/50 rounded-lg transition duration-300' : "fixed right-[-200px]"}`} onClick={handleNavMenu}>
